...
const prosGame = {
  ...
  variants: [
    ...
    { id: 'tt', name: 'Time Trial Tempo', watts: 480, seconds: 240, note: 'Top time triallists sustain roughly 480W on flat, full-gas efforts.' },
    { id: 'hour', name: 'Hour Record Pace', watts: 440, seconds: 300, note: 'The modern Hour Record demands ~440W. You only have to do 5 of the 60 minutes.' },
    { id: 'climb', name: 'GC Climb Record Pace', watts: 460, seconds: 600, note: 'Record-breaking Grand Tour summit performances sit near 460W for 40 minutes. Here\u2019s a 10-minute taste.' },
  ],
  howTo: [
